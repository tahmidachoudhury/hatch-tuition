...
export default function Hero() {
  return (
    <Box
      ...
      sx={{
        height: "55vh",
        backgroundColor: "#a5d5e5",
        position: "relative",
        pb: "20px",
      }}
    >
      <Typography variant="h4" color="#4a5c64" zIndex={2}>
        Catching up? Getting ahead? Preparing for exams?
      </Typography>
      <Typography variant="h1" color="#4a5c64" zIndex={2}>
      ...
      >
        ...
        >
          <circle cx="60%" cy="100%" r="30vh" style={{ fill: "#beefff" }} />
        </svg>
      </Box>
      <Box
        sx={{
      ...
      >
        <svg
          ...
          style={{
            filter:
              "invert(84%) sepia(41%) saturate(1010%) hue-rotate(357deg) brightness(99%) contrast(106%)",
            position: "absolute",
            bottom: 0,
            opacity: 0.5,
            width: "100%",
      ...
      >
        ...
        >
          <circle cx="50" cy="50" r="20vw" style={{ fill: "#FAD02C" }} />
        </svg>
      </Box>
    </Box>
  )
